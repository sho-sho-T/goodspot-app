		...
		<div className="p-8 max-w-2xl mx-auto">
			...
			<div className="space-y-3">
				...
				{items.map((item) => (
					<div
						key={item.id}
						className="flex items-center justify-between p-4 border rounded-lg bg-white dark:bg-gray-900 shadow-sm hover:shadow-md transition-shadow"
					>
						<div>
						...
						<div className="flex gap-2">
							<form action={updateItem}>
								...
								<button
									type="submit"
									className="bg-yellow-500 text-white px-3 py-1.5 rounded hover:bg-yellow-600 text-sm transition-colors"
								>
									Random Update
								</button>
							</form>
							<form action={deleteItem}>
								...
								<button
									type="submit"
									className="bg-red-500 text-white px-3 py-1.5 rounded hover:bg-red-600 text-sm transition-colors"
								>
									Delete
								</button>
							</form>
